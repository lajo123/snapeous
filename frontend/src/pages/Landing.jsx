...
export default function Landing() {
  ...
  return (
    <div className="grain-bg text-[#2A2A2A] antialiased min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 glass border-b border-white/20">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#6b6560]">
            <a href="#features" className="hover:text-[#2A2A2A] transition-colors">{t('nav.features')}</a>
            <a href="#how-it-works" className="hover:text-[#2A2A2A] transition-colors">{t('nav.howItWorks')}</a>
            <a href="#pricing" className="hover:text-[#2A2A2A] transition-colors">{t('nav.pricing')}</a>
            <a href="#faq" className="hover:text-[#2A2A2A] transition-colors">{t('nav.faq')}</a>
          </div>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <>
                ...
                <Link to={lp('/register')} className="bg-brand-600 text-white text-sm font-medium px-5 py-2 rounded-full hover:bg-brand-700 transition-all hover:shadow-lg hover:shadow-brand-500/20 hover:-translate-y-0.5">
                  {t('nav.freeTrial')}
                </Link>
              </>
            )}
      ...
      <main className="flex-grow pt-32 pb-20 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[#6b6560] max-w-2xl mx-auto mb-10 font-medium leading-relaxed">
            {t('hero.description')}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
            ...
            <a href="#how-it-works" className="w-full sm:w-auto glass text-[#2A2A2A] text-base font-medium px-8 py-3.5 rounded-full hover:bg-white/60 transition-all flex items-center justify-center gap-2">
              <Play size={16} />
              {t('hero.demo')}
            </a>
          </div>
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="glass rounded-2xl md:rounded-[2rem] p-2 shadow-2xl">
              <div className="bg-white/70 backdrop-blur-xl rounded-xl md:rounded-[1.5rem] border border-[#E8DCCB] overflow-hidden shadow-inner">
                <div className="h-11 border-b border-[#E8DCCB] flex items-center px-4 justify-between bg-white/40">
                  <div className="flex gap-1.5">
                    <div className="w-2.5 h-2.5 rounded-full bg-black/10" />
                    <div className="w-2.5 h-2.5 rounded-full bg-black/10" />
                    <div className="w-2.5 h-2.5 rounded-full bg-black/10" />
                  </div>
                  <div className="text-xs font-medium text-[#9a9080]">app.snapeous.io/dashboard</div>
                  <div className="w-8" />
                </div>
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
                  <div className="col-span-1 space-y-4">
                    <div className="bg-white rounded-xl p-4 border border-[#E8DCCB] shadow-sm">
                      <div className="text-[11px] font-semibold uppercase tracking-widest text-[#9a9080] mb-1 flex items-center justify-between">
                        {t('mockup.activeBacklinks')}
                        <Link2 size={14} className="text-[#9a9080]" />
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-4 border border-[#E8DCCB] shadow-sm">
                      <div className="text-[11px] font-semibold uppercase tracking-widest text-[#9a9080] mb-1 flex items-center justify-between">
                        ...
                        <Shield size={14} className="text-[#9a9080]" />
                      </div>
                      <div className="text-2xl font-bold tracking-tight text-brand-600">87<span className="text-base text-[#9a9080] font-medium">/100</span></div>
                      <div className="w-full bg-[#E8DCCB] rounded-full h-1.5 mt-2">
                  ...
                  <div className="col-span-1 md:col-span-2 bg-white rounded-xl border border-[#E8DCCB] shadow-sm overflow-hidden">
                    <div className="px-5 py-3.5 border-b border-[#E8DCCB] flex justify-between items-center bg-[#FAF7F2]">
                      <div className="text-sm font-semibold tracking-tight">{t('mockup.recentBacklinks')}</div>
                      <div className="text-[11px] font-semibold uppercase tracking-widest text-[#9a9080]">DA</div>
                    </div>
                    {[
                      ...
                      <div key={i} className={`px-5 py-3 ${i < 2 ? 'border-b border-[#E8DCCB]/60' : ''} flex items-center justify-between hover:bg-[#FAF7F2] transition-colors`}>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-[#9a9080]">{row.meta}</div>
                          </div>
                        </div>
                    ...
                    <div className="px-5 py-3 bg-[#FAF7F2] border-t border-[#E8DCCB]/60">
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-[#9a9080]">{t('mockup.dofollowNofollow')}</span>
      ...
      {/* ─── SOCIAL PROOF ───────────────────────────────────────── */}
      <section className="py-16 border-t border-[#E8DCCB]/50">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="text-[11px] font-semibold uppercase tracking-widest text-[#9a9080] mb-8">{t('socialProof.title')}</p>
          <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 opacity-40">
            {['Agence&Co', 'NetRank', 'DigiVox', 'SEO Studio', 'LinkForge'].map((n) => (
              <span key={n} className="text-xl font-bold tracking-tight">{n}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 relative">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[#6b6560] font-medium max-w-xl mx-auto text-base leading-relaxed">{t('features.subtitle')}</p>
          </div>
            ...
            {Array.isArray(features) && features.map((feat, i) => {
              ...
              return (
                <div key={i} className="glass p-8 rounded-3xl hover:bg-white/60 transition-all duration-300 group">
                  <div className="w-12 h-12 rounded-2xl bg-white border border-[#E8DCCB] flex items-center justify-center shadow-sm mb-6 group-hover:scale-110 group-hover:shadow-md transition-all duration-300">
                    <Icon size={20} className="text-brand-600" />
                  </div>
                  <h3 className="text-xl font-semibold tracking-tight mb-2">{feat.title}</h3>
                  <p className="text-sm text-[#6b6560] leading-relaxed font-medium">{feat.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section id="how-it-works" className="py-24 relative">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">{t('howItWorks.title')}</h2>
            <p className="text-[#6b6560] font-medium max-w-xl mx-auto text-base leading-relaxed">{t('howItWorks.subtitle')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {Array.isArray(steps) && steps.map((step, i) => (
              <div key={i} className="relative text-center">
                ...
                <p className="text-sm text-[#6b6560] leading-relaxed font-medium">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative z-10">
              {[
                ...
                <div key={label}>
                  ...
                  <div className="text-sm text-[#6b6560] font-medium mt-2">{label}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            {Array.isArray(testimonials) && testimonials.map((item, i) => {
              ...
              return (
                <div key={i} className="glass p-8 rounded-3xl">
                  ...
                  <p className="text-sm text-[#3a3a3a] leading-relaxed mb-6">&ldquo;{item.text}&rdquo;</p>
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-full ${color} flex items-center justify-center font-semibold text-sm`}>{initials}</div>
                    <div>
                      <div className="text-sm font-semibold">{item.name}</div>
                      <div className="text-xs text-[#9a9080]">{item.role}</div>
                    </div>
                  </div>
                </div>
              );
      ...
      <section id="pricing" className="py-24 relative">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-[#6b6560] font-medium max-w-xl mx-auto text-base leading-relaxed">{t('pricing.subtitle')}</p>
            ...
            {Array.isArray(plans) && plans.map((plan, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={cn('text-sm font-semibold mb-1', isRecommended ? 'text-white/70' : 'text-[#6b6560]')}>
                    {plan.name}
                  </div>
                  <div className="text-4xl font-bold tracking-tight mb-1">
                    {isFree ? t('pricing.free') : `${price}\u20AC`}
                    {!isFree && (
                      <span className={cn('text-lg font-medium', isRecommended ? 'text-white/60' : 'text-[#9a9080]')}>{t('pricing.perMonth')}</span>
                    )}
                  </div>
                  ...
                  <div className={cn('text-sm mb-5 mt-1', isRecommended ? 'text-white/60' : 'text-[#9a9080]')}>
                    {plan.sub}
                  </div>
                  ...
                  <ul className="space-y-2.5 mb-8 flex-1">
                    {Array.isArray(plan.items) && plan.items.map((item, j) => (
                      <li key={j} className={cn('flex items-start gap-2.5 text-sm', isRecommended ? 'text-white/90' : 'text-[#3a3a3a]')}>
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isRecommended
                        ...
                        : isFree
                          ? 'glass text-[#2A2A2A] hover:bg-white/60'
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-2 lg:sticky lg:top-24 lg:self-start">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">{t('faq.title')}</h2>
            </div>

            <div className="lg:col-span-3">
              <div className="divide-y divide-[#E8DCCB]/80">
                    ...
                    >
                      ...
                      >
                        <h3 className={cn(
                          ...
                          isOpen ? 'text-brand-700' : 'text-[#2A2A2A] group-hover:text-brand-600'
                        )}>
                          {faq.q}
                        </h3>
                        <div className={cn(
                          ...
                          isOpen
                            ...
                            : 'bg-[#E8DCCB]/60 text-[#9a9080] group-hover:bg-brand-100 group-hover:text-brand-600'
                        )}>
                          <ChevronDown size={14} className="faq-chevron" strokeWidth={2.5} />
                        </div>
                      </button>
                      <div className="faq-answer">
                        <div>
                          <p className="pb-6 text-sm text-[#6b6560] leading-relaxed pr-12">
                            {faq.a}
                          </p>
                        </div>
                      </div>
      ...
      <section className="px-6 md:px-12 py-24">
        <div className="bg-navy-600 rounded-[2rem] relative overflow-hidden py-20 px-6">
          ...
          <div className="max-w-3xl mx-auto text-center text-white relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">{t('cta.title')}</h2>
      ...
      {/* ─── FOOTER ─────────────────────────────────────────────── */}
      <footer className="mt-12 border-t border-[#E8DCCB]/50 py-16 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-[#6b6560] leading-relaxed">{t('footer.description')}</p>
            </div>
            {[
              { heading: t('footer.product'), links: [
                ...
                { label: t('footer.productLinks.changelog'), href: '#' },
              ]},
              ...
              <div key={heading}>
                <h4 className="text-[11px] font-semibold uppercase tracking-widest text-[#9a9080] mb-4">{heading}</h4>
                <ul className="space-y-2.5">
                  {links.map(({ label, href }) => (
                    <li key={label}>
                      {href.startsWith('#') ? (
                        <a href={href} className="text-sm text-[#6b6560] hover:text-[#2A2A2A] transition-colors">{label}</a>
                      ) : (
                        <Link to={href} className="text-sm text-[#6b6560] hover:text-[#2A2A2A] transition-colors">{label}</Link>
                      )}
                    </li>
                  ))}
                </ul>
          ...
          <div className="border-t border-[#E8DCCB]/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-xs text-[#9a9080]">{t('footer.copyright', { year: new Date().getFullYear() })}</div>
            <div className="flex items-center gap-5">
              <LanguageSwitcher />
              <a href="#" className="text-[#9a9080] hover:text-[#2A2A2A] transition-colors" aria-label="Twitter">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href="#" className="text-[#9a9080] hover:text-[#2A2A2A] transition-colors" aria-label="LinkedIn">
