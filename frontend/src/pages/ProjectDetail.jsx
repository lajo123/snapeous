          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAF7F2', border: '1px solid #EDE4D3' }}>
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <p className="text-xs font-semibold uppercase tracking-wider text-[#9a9080]">Domain Rank</p>
              </div>
              <p className="text-2xl font-bold text-gray-900">{dm.domain_rank ?? '--'}</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAF7F2', border: '1px solid #EDE4D3' }}>
              <div className="flex items-center gap-2 mb-1.5">
                <BarChart3 className="h-4 w-4 text-blue-600" />
                <p className="text-xs font-semibold uppercase tracking-wider text-[#9a9080]">URL Rank</p>
              </div>
              <p className="text-2xl font-bold text-gray-900">{dm.url_rank ?? '--'}</p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAF7F2', border: '1px solid #EDE4D3' }}>
              <div className="flex items-center gap-2 mb-1.5">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {dm.backlinks_count != null ? Number(dm.backlinks_count).toLocaleString('fr-FR') : '--'}
              </p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAF7F2', border: '1px solid #EDE4D3' }}>
              <div className="flex items-center gap-2 mb-1.5">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {dm.referring_domains != null ? Number(dm.referring_domains).toLocaleString('fr-FR') : '--'}
              </p>
            </div>
            <div className="rounded-xl p-4" style={{ backgroundColor: '#FAF7F2', border: '1px solid #EDE4D3' }}>
              <div className="flex items-center gap-2 mb-1.5">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {(() => {
                  const df = Number(dm.dofollow_backlinks || 0);
                  const nf = Number(dm.nofollow_backlinks || 0);
                  const total = df + nf;
