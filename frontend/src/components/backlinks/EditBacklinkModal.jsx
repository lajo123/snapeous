  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-4">{t('editModal.title')}</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('editModal.sourceUrl')}</label>
            <input
              type="url"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('editModal.targetUrl')}</label>
            <input
              type="url"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('editModal.anchorText')}</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('editModal.type')}</label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">{t('editModal.status')}</label>
              <select
